...
In the context of Coq, Danvy explores the use of fold/unfold lemmas to mechanize
equational reasoning about recursive programs in the Coq proof
assistant~\cite{DANVY_2022}. By formalizing recursive program transformations,
fold-unfold lemmas enable optimizations like fusion by allowing programs to be
systematically simplified, eliminating intermediate structures.
