...
respect setoid equalities. We use special notation for such morphisms,
\coq{A ~> B}, and we add an implicit coercion from \coq{A ~> B} to \coq{A -> B}.
We also provide tactics to automatically discharge proofs that morphisms are
