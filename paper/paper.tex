...
casts into extracted code (for example, \ocaml{Obj.magic} in OCaml).
...
human programmer would write, and contains no occurrences of \ocaml{Obj.magic}.
...
code. The absence of \ocaml{Obj.magic} provides even stronger guarantees to the
...
the code contained \ocaml{Obj.magic}. For example, the programmer would need to
...
\ocaml{Obj.magic} makes it easer to reason about, and interoperate with
extracted code. 
