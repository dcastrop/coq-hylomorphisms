...
(e.g.) Haskell and ML, recursion schemes cannot ensure termination. This is because the
input information itself could be non-terminating. On the other hand, while
...
extract is \coq{hylo (merge \o natural times_two) tsplit}. In this definition,
