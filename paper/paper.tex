...
recursion schemes, is that they enjoy well-estabished \emph{algebraic
...
subproblems (divide), then subsolutions are computed recursively, and, finally,
these subsolutions are put together to compute the solution to the original
...
are the Quicksort and Mergesort algorithms (Section~\ref{sec:sorting}), dynammic
