...
to reason about program equivalences. Despite their useful properties, not many 
pieces of work formalise them in a proof assistant, partly due to the difficulty
of dealing with termination, and reasoning about program equivalences. In this work,
we tackle these problems by
