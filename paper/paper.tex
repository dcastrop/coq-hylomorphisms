...
position. Thus, we require that all the types used in our definitions are
...
\end{coqcode}
We add an automatic coercion from \coq{A ~> B} to \coq{A -> B} and provide tactics
to automatically discharge proofs that \coq{forall x y, x =e y -> f x =e f y}
for the simplest cases of \coq{f}.
