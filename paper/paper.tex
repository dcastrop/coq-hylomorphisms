...
The recursive structure of quicksort and mergesort is given by the following
functor
\begin{coqcode}
Inductive ITreeF N X := i_leaf | i_node (n : N) (l r : X)
\end{coqcode}
To explain this consider quicksort.
The list is split into a pivot which is represented by the and two sublists. We define the data functor of trees as follows:
...
\end{coqcode}
We name \coq{TreeF} the container that has these shapes and (base) positions.
...
% %
% \label{sec:fusion}
Fusion in functional programming is a more general technique for combining multiple
...
In this work we mechanise hylomorphisms and their algebraic laws and use them
to perform optimisations for programs than can be later extracted into human-readable and runnable code.
We do this in a \emph{fully
  axiom-free}.

This formalisation allows the use of program calculation techniques in Coq to derive
...
the more thorough and systematic use of proof automation for respectful
