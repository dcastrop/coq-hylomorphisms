...
systematically simplified, eliminating intermediate structures. Additionally, an
approach to deforestation called the worker/wrapper transformation~\cite{gill09}
was formalised and mechanised in Agda~\cite{SCULTHORPE_HUTTON_2014}.
