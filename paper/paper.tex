...
for proper morphisms and we add an implicit coercion from \coq{A ~> B} to \coq{A -> B}.  We also provide tactics to automatically discharge proofs that morphisms are proper,  for some simple cases.
