...
\]
We can model this functor by using a set $S$ defined by $A + B + C$


which distinguishes the three cases, and a function $P$ which tells us the
number of occurrences of $X$ in each case: for $s = (1,a) \mapsto \emptyset$;
for $s = (2, b) \mapsto 1$ the singleton set and  for $s = (3, c) \mapsto 2$ the
$2$-element set.
