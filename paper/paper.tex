...
$f : (X, \gamma_{X}) \to (Y, \gamma_{Y})$ we have
\begin{equation}
  \label{eq:ana:fusion}
  \ana{\gamma_{Y}} \circ f = \ana{\gamma_{X}}
\end{equation}
...
The uniqueness property of the hylo yields the following fusion law:
\begin{equation}
...
$(A, c_{1})$ is an recursive coalgebra
$(B, c_{2})$ is an recursive coalgebra

$(C, a_{2})$ is an algebra
$(B, a_{1})$ is an algebra

$c_{2} \circ a_{1} = id$

\begin{equation}
  \label{eq:hylo:deforestation}
  \hylo{a_{2}}{c_{2}} \circ \hylo{a_{1}}{c_{1}} = \hylo{a_{2}}{c_{1}}
\end{equation}
